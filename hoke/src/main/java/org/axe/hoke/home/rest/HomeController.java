...
html.append("window.location = \""+contextPath+"/axe-hoke?token="+token+"\";");
html.append("}");
html.append("</script>");
html.append("</head>");
html.append("<body>");
...
html.append("<td align=\"left\"><a href=\""+contextPath+"/axe-hoke/hoke_data_package/view?poolKey="+poolKey+"&token="+token+"\">"+simplePoolKey+"</a></td>");
...
html.append("<td align=\"left\"><a href=\""+contextPath+"/axe-hoke/hoke_data_package/delete?poolKey="+poolKey+"&token="+token+"\">删除</td>");
html.append("</tr>");
}
html.append("</table>");
html.append("</td></tr><tr><td>&nbsp;</td></tr>");
...
html.append("<table width=\"100%\">");
html.append("<tr><td align=\"right\">");
html.append("<a style=\"font-size: 15px;color: #AE0000\" href=\""+contextPath+"/axe-hoke?token="+token+"\"><b>Hoke</b></a>");
html.append("</td></tr>");
...
html.append("<table width=\"100%\">");
html.append("<tr><td align=\"right\">");
html.append("<a style=\"font-size: 15px;color: #AE0000\" href=\""+contextPath+"/hoke?token="+token+"\"><b>Hoke</b></a>");
html.append("</td></tr>");
html.append("<tr><td align=\"center\"><font size=\"28\">Hoke Data Package Delete "+result+"</font></td></tr>");
html.append("<tr><td align=\"center\"><span id=\"number\">10</span>秒后自动跳转<a href=\""+contextPath+"/axe-hoke?token="+token+"\">/hoke首页</a></td></tr>");
html.append("</table>");
html.append("</body>");
html.append("</html>");
printHtml(response, html.toString());
